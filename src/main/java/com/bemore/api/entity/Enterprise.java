...
public class Enterprise {
	...
	public String getStartDate() {
		return startDate==null?"":startDate.replace(" 00:00:00","");
	}

	public void setStartDate(String startDate) {
		this.startDate = startDate==null?"":startDate.replace(" 00:00:00","");
	}

	public void setStartTimez(LocalDate startTimez) {
		this.startTimez = startTimez;
		if (StringUtils.hasLength(startDate))
			this.startTimez = LocalDate.parse(startDate.replace(" 00:00:00",""), DateTimeFormatter.ofPattern("yyyy-MM-dd"));
	}

	public LocalDate getStartTimez() {
		if (StringUtils.hasLength(startDate))
			startTimez = LocalDate.parse(startDate.replace(" 00:00:00",""), DateTimeFormatter.ofPattern("yyyy-MM-dd"));
		return startTimez;
	}
}
